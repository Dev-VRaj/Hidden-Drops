...
let entryList1 = [
    ['tshirt-3310850_960_720.png', 'T-Shirt', '3900 L', 'per T-Shirt', true],
    ...
    ['wheat.webp', 'Wheat', '900 L', 'per Kg', true],
    ['cocoa.jpg', 'Cocoa', '1700 L', 'per 100g'],
    ['almonds.jpg', 'Almonds', '3.78 L', 'per almond', true], //(https://endtrophyhuntingnow.com/2015/05/09/17567/factory-farming-stats-water-nuts-eggs-hamburgers/)
    ['sugar.jpg', 'Sugar', '2515 L', 'per Kg', true],
    ['bread.jpg', 'Bread', '58 L', 'per slice', true], 
    ['cheese.jpg', 'Cheese', '49 L', 'per slice', true],
    ['butter-1449453_960_720.jpg', 'Butter', '555.3 L', 'per 100g'],
    ['chicken.jpg', 'Chicken meat', '4325 L', 'per Kg', true],
    ['pizza.jfif', 'Pizza', '2139 L', 'per pizza'],
    ['burger.jpg', 'Cheeseburger', '2644 L', 'per burger'], //(water consumption & factory farming memes)
    ['ice_cream.jpg', 'Icecream prod.', '159 L', 'per scoop', true], //(https://www.motherjones.com/wp-content/uploads/Dairy-comparisons_0.gif)
    ['pasta-2805203_1280.jpg', 'Pasta', '1849 L', 'per Kg'],
    ['apple-fruits-natural-102104.jpg', 'Apple', '70 L', 'per apple', true],
    ['banana-2449019_960_720.png', 'Banana', '95 L', 'per banana', true],
    ['potato.jpg', 'Potato', '50 L', 'per potato', true],
    ['cabbage.jpg', 'Cabbage', '237 L', 'per Kg', true],
...
entryList2 = [
    ['tomato.jfif', 'Tomato', '18 L', 'per tomato', true],
    ['lettuce.jpg', 'Lettuce', '126.3 L', 'per Kg', true], //(https://www.amazon.in/dp/B014WIMZBM/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1)
    ['egg.jpg', 'Egg', '196 L', 'per egg', true],
    ['car.jpg', 'Car', '147631 L', 'per Car', true],
    ['bike-wheel-cycling-tourism.jpg', 'Bicycle', '132 L', 'per bicycle'],
    ['paper.jpg', 'Paper', '2-13 L', 'per A4 size paper', true],
    ['android-phone-mobile-phone-smartphone-smartphones-2466542.jpg', 'Smartphone', '12075 L', 'per smartphone'],
    ['toothbrush.jpg', 'Not turning off tap', '12-15 L', 'each brushing session', true],
    ['shower-653671_960_720.jpg', 'Bathing', '161 L', 'per bath', true],
    ...
    ['paint.jpg', 'Paint', '190 L', 'per litre', true], //(https://images-na.ssl-images-amazon.com/images/I/819anKX%2BsRL.jpg)
    ['leather-shoe-wallpaper-preview.jpg', 'Leather boots', '25000 L', 'per pair'],
    ['bottles-4251473_960_720.jpg', 'Plastic bottle', '2.5 L', 'per bottle', true],
    ...
    ['wine.jpg', 'Wine', '109 L', 'per glass', true],
    ['rubber.jpg', 'Synthetic Rubber', '458 L', 'per Kg', true], //(https://images-na.ssl-images-amazon.com/images/I/819anKX%2BsRL.jpg)
